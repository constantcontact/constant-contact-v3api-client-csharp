...
namespace ConstantContactApi.Api
{
    ...
    public interface IContactsCustomFieldsApiSync : IApiAccessor
    {
        ...
        /// <param name="createCustomFieldsRequest">The JSON payload required to create a new custom field.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GetCustomField200Response</returns>
        GetCustomField200Response CreateCustomFields(CreateCustomFieldsRequest createCustomFieldsRequest, int operationIndex = 0);
        ...
        ApiResponse<GetCustomField200Response> CreateCustomFieldsWithHttpInfo(CreateCustomFieldsRequest createCustomFieldsRequest, int operationIndex = 0);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="ConstantContactApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="customFieldId">The ID that uniquely identifies the custom field to delete.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        ...
        /// </remarks>
        /// <exception cref="ConstantContactApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="customFieldId">The ID that uniquely identifies the custom field.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GetCustomField200Response</returns>
        ...
        /// </remarks>
        /// <exception cref="ConstantContactApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="customFieldId">The ID that uniquely identifies the custom field to update.</param>
    ...
    public interface IContactsCustomFieldsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<GetCustomField200Response> CreateCustomFieldsAsync(CreateCustomFieldsRequest createCustomFieldsRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<GetCustomField200Response>> CreateCustomFieldsWithHttpInfoAsync(CreateCustomFieldsRequest createCustomFieldsRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// DELETE a custom_field
        /// </summary>
        /// <remarks>
    ...
    public partial class ContactsCustomFieldsApi : IContactsCustomFieldsApi
    {
        ...
        /// <summary>
        /// POST (create) a custom_field Custom fields are extra data fields you create to store additional information about your contacts, such as preferences, membership levels, and interests. Use custom fields to organize contacts, send personalized email campaigns, and to identify a targeted audience for a specific campaign. Custom fields types include text, number, date, drop-down lists, radio buttons, and checkboxes. A user can configure up to 100 &#x60;custom_fields&#x60; in their account.
        /// </summary>
        /// <exception cref="ConstantContactApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="createCustomFieldsRequest">The JSON payload required to create a new custom field.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GetCustomField200Response</returns>
        public GetCustomField200Response CreateCustomFields(CreateCustomFieldsRequest createCustomFieldsRequest, int operationIndex = 0)
        {
            ConstantContactApi.Client.ApiResponse<GetCustomField200Response> localVarResponse = CreateCustomFieldsWithHttpInfo(createCustomFieldsRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetCustomField200Response</returns>
        public ConstantContactApi.Client.ApiResponse<GetCustomField200Response> CreateCustomFieldsWithHttpInfo(CreateCustomFieldsRequest createCustomFieldsRequest, int operationIndex = 0)
        {
            // verify the required parameter 'createCustomFieldsRequest' is set
            if (createCustomFieldsRequest == null)
            {
                throw new ConstantContactApi.Client.ApiException(400, "Missing required parameter 'createCustomFieldsRequest' when calling ContactsCustomFieldsApi->CreateCustomFields");
            }
            ...
            localVarRequestOptions.Data = createCustomFieldsRequest;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetCustomField200Response</returns>
        public async System.Threading.Tasks.Task<GetCustomField200Response> CreateCustomFieldsAsync(CreateCustomFieldsRequest createCustomFieldsRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ConstantContactApi.Client.ApiResponse<GetCustomField200Response> localVarResponse = await CreateCustomFieldsWithHttpInfoAsync(createCustomFieldsRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetCustomField200Response)</returns>
        public async System.Threading.Tasks.Task<ConstantContactApi.Client.ApiResponse<GetCustomField200Response>> CreateCustomFieldsWithHttpInfoAsync(CreateCustomFieldsRequest createCustomFieldsRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'createCustomFieldsRequest' is set
            if (createCustomFieldsRequest == null)
            {
        ...
        /// <summary>
        /// DELETE a custom_field Delete a custom field from the user&#39;s account.
        /// </summary>
        /// <exception cref="ConstantContactApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="customFieldId">The ID that uniquely identifies the custom field to delete.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        ...
        /// <summary>
        /// GET custom_fields Collection Get all custom fields defined in the user&#39;s account. &lt;div class&#x3D;\&quot;Msg\&quot;&gt;&lt;p class&#x3D;\&quot;note-text\&quot;&gt;This method does not currently support filtering results using the custom field update date.&lt;/p&gt;&lt;/div&gt;
        /// </summary>
        /// <exception cref="ConstantContactApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="limit">Specifies the number of results displayed per page of output, from 1 - 100, default &#x3D; 50. (optional, default to 50)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        ...
        /// <summary>
        /// GET a custom_field Get details for a specified custom field.
        /// </summary>
        /// <exception cref="ConstantContactApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="customFieldId">The ID that uniquely identifies the custom field.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        ...
        /// <summary>
        /// Update a custom field. Update an existing custom field.
        /// </summary>
        /// <exception cref="ConstantContactApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="customFieldId">The ID that uniquely identifies the custom field to update.</param>
        /// <param name="updateCustomFieldRequest">The JSON payload used to update an existing custom field. Any properties omitted in the PUT request are overwritten with a null value.</param>
