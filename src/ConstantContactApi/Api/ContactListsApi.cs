...
namespace ConstantContactApi.Api
{
    ...
    public interface IContactListsApiSync : IApiAccessor
    {
        ...
        /// <param name="channelType">Use to return lists by channel type. The default value is &#x60;email&#x60;. (optional)</param>
        /// <param name="includeSmsMembershipCount">Set to &#x60;true&#x60; to return the total number of SMS members in each list. Only applicable when &#x60;channel_type&#x60; is &#x60;sms&#x60;. Default is &#x60;false&#x60;. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GetAllLists200Response</returns>
        GetAllLists200Response GetAllLists(int? limit = default(int?), bool? includeCount = default(bool?), string? includeMembershipCount = default(string?), string? name = default(string?), string? status = default(string?), string? channelType = default(string?), bool? includeSmsMembershipCount = default(bool?), int operationIndex = 0);
        ...
        ApiResponse<GetAllLists200Response> GetAllListsWithHttpInfo(int? limit = default(int?), bool? includeCount = default(bool?), string? includeMembershipCount = default(string?), string? name = default(string?), string? status = default(string?), string? channelType = default(string?), bool? includeSmsMembershipCount = default(bool?), int operationIndex = 0);
        /// <summary>
        /// GET a List
        /// </summary>
        /// <remarks>
    ...
    public interface IContactListsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<GetAllLists200Response> GetAllListsAsync(int? limit = default(int?), bool? includeCount = default(bool?), string? includeMembershipCount = default(string?), string? name = default(string?), string? status = default(string?), string? channelType = default(string?), bool? includeSmsMembershipCount = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ContactListsApi : IContactListsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GetAllLists200Response</returns>
        public GetAllLists200Response GetAllLists(int? limit = default(int?), bool? includeCount = default(bool?), string? includeMembershipCount = default(string?), string? name = default(string?), string? status = default(string?), string? channelType = default(string?), bool? includeSmsMembershipCount = default(bool?), int operationIndex = 0)
        {
            ConstantContactApi.Client.ApiResponse<GetAllLists200Response> localVarResponse = GetAllListsWithHttpInfo(limit, includeCount, includeMembershipCount, name, status, channelType, includeSmsMembershipCount);
            return localVarResponse.Data;
        }
        ...
        public ConstantContactApi.Client.ApiResponse<GetAllLists200Response> GetAllListsWithHttpInfo(int? limit = default(int?), bool? includeCount = default(bool?), string? includeMembershipCount = default(string?), string? name = default(string?), string? status = default(string?), string? channelType = default(string?), bool? includeSmsMembershipCount = default(bool?), int operationIndex = 0)
        {
            ...
            if (channelType != null)
            {
                localVarRequestOptions.QueryParameters.Add(ConstantContactApi.Client.ClientUtils.ParameterToMultiMap("", "channel_type", channelType));
            }
            if (includeSmsMembershipCount != null)
            {
                localVarRequestOptions.QueryParameters.Add(ConstantContactApi.Client.ClientUtils.ParameterToMultiMap("", "include_sms_membership_count", includeSmsMembershipCount));
            }
        ...
        {
            ConstantContactApi.Client.ApiResponse<GetAllLists200Response> localVarResponse = await GetAllListsWithHttpInfoAsync(limit, includeCount, includeMembershipCount, name, status, channelType, includeSmsMembershipCount, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
