...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getCampaignActivityLinkReport_200_response_link_click_counts_inner")]
    public partial class GetCampaignActivityLinkReport200ResponseLinkClickCountsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCampaignActivityLinkReport200ResponseLinkClickCountsInner" /> class.
        /// </summary>
        ...
        public GetCampaignActivityLinkReport200ResponseLinkClickCountsInner(string linkUrl = default(string), string urlId = default(string), int uniqueClicks = default(int), string listAction = default(string), Guid listId = default(Guid), string linkTag = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCampaignActivityLinkReport200ResponseLinkClickCountsInner {\n");
