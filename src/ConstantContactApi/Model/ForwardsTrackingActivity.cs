...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ForwardsTrackingActivity")]
    public partial class ForwardsTrackingActivity : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForwardsTrackingActivity" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ForwardsTrackingActivity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ForwardsTrackingActivity" /> class.
        /// </summary>
        ...
        public ForwardsTrackingActivity(Guid contactId = default(Guid), Guid campaignActivityId = default(Guid), string trackingActivityType = default(string), string emailAddress = default(string), string firstName = default(string), string lastName = default(string), DateTime createdTime = default(DateTime), DateTime deletedAt = default(DateTime))
        {
            ...
            {
                throw new ArgumentNullException("trackingActivityType is a required property for ForwardsTrackingActivity and cannot be null");
            }
            this.TrackingActivityType = trackingActivityType;
            // to ensure "emailAddress" is required (not null)
            if (emailAddress == null)
            {
                throw new ArgumentNullException("emailAddress is a required property for ForwardsTrackingActivity and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForwardsTrackingActivity {\n");
