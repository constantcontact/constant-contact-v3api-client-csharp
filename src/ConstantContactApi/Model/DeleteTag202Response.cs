...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "deleteTag_202_response")]
    public partial class DeleteTag202Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteTag202Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeleteTag202Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteTag202Response" /> class.
        /// </summary>
        ...
        public DeleteTag202Response(string activityId = default(string), string state = default(string), DeleteTag202ResponseStatus status = default(DeleteTag202ResponseStatus), DeleteTag202ResponseLinks links = default(DeleteTag202ResponseLinks))
        {
            // to ensure "activityId" is required (not null)
            if (activityId == null)
            {
                throw new ArgumentNullException("activityId is a required property for DeleteTag202Response and cannot be null");
            }
            this.ActivityId = activityId;
            // to ensure "state" is required (not null)
            if (state == null)
            {
                throw new ArgumentNullException("state is a required property for DeleteTag202Response and cannot be null");
            }
            this.State = state;
            this.Status = status;
            this.Links = links;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteTag202Response {\n");
