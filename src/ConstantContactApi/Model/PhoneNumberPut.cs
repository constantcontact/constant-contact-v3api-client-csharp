...
namespace ConstantContactApi.Model
{
    ...
    /// PhoneNumberPut
    /// </summary>
    [DataContract(Name = "PhoneNumberPut")]
    public partial class PhoneNumberPut : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PhoneNumberPut" /> class.
        /// </summary>
        ...
        public PhoneNumberPut(string phoneNumber = default(string), string kind = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PhoneNumberPut {\n");
