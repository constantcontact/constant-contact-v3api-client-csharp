...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OptoutsTrackingActivity")]
    public partial class OptoutsTrackingActivity : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptoutsTrackingActivity" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OptoutsTrackingActivity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OptoutsTrackingActivity" /> class.
        /// </summary>
        ...
        public OptoutsTrackingActivity(Guid contactId = default(Guid), Guid campaignActivityId = default(Guid), string trackingActivityType = default(string), string emailAddress = default(string), string firstName = default(string), string lastName = default(string), string optOutReason = default(string), DateTime createdTime = default(DateTime), DateTime deletedAt = default(DateTime))
        {
            ...
            {
                throw new ArgumentNullException("trackingActivityType is a required property for OptoutsTrackingActivity and cannot be null");
            }
            this.TrackingActivityType = trackingActivityType;
            // to ensure "emailAddress" is required (not null)
            if (emailAddress == null)
            {
                throw new ArgumentNullException("emailAddress is a required property for OptoutsTrackingActivity and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OptoutsTrackingActivity {\n");
