...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createDeleteActivity_201_response_status")]
    public partial class CreateDeleteActivity201ResponseStatus : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDeleteActivity201ResponseStatus" /> class.
        /// </summary>
        /// <param name="listCount">The number of lists if request specifies contacts to delete by list_ids..</param>
        public CreateDeleteActivity201ResponseStatus(int listCount = default(int))
        {
        ...
        /// </summary>
        /// <value>The number of lists if request specifies contacts to delete by list_ids.</value>
        /// <example>4</example>
        ...
        /// </summary>
        /// <value>The total number of contacts to delete.</value>
        /// <example>375</example>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateDeleteActivity201ResponseStatus {\n");
