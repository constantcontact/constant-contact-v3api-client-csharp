...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountEmailCreateResponse")]
    public partial class AccountEmailCreateResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountEmailCreateResponse" /> class.
        /// </summary>
        ...
        public AccountEmailCreateResponse(string emailAddress = default(string), long emailId = default(long), string confirmStatus = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountEmailCreateResponse {\n");
