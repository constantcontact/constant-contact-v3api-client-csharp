...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ActivityImport")]
    public partial class ActivityImport : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActivityImport" /> class.
        /// </summary>
        ...
        public ActivityImport(string state = default(string), CreateCSVImportActivity201ResponseStatus status = default(CreateCSVImportActivity201ResponseStatus), CreateCSVImportActivity201ResponseLinks links = default(CreateCSVImportActivity201ResponseLinks))
        {
            this.State = state;
            this.Status = status;
            this.Links = links;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActivityImport {\n");
