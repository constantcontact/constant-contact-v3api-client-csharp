...
namespace ConstantContactApi.Model
{
    ...
    /// QueryParamObject
    /// </summary>
    [DataContract(Name = "QueryParamObject")]
    public partial class QueryParamObject : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryParamObject" /> class.
        /// </summary>
        ...
        public QueryParamObject(string queryParamKey = default(string), string queryParamValue = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueryParamObject {\n");
