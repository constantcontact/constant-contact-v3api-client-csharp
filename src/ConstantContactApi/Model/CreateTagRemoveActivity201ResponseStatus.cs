...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createTagRemoveActivity_201_response_status")]
    public partial class CreateTagRemoveActivity201ResponseStatus : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTagRemoveActivity201ResponseStatus" /> class.
        /// </summary>
        ...
        public CreateTagRemoveActivity201ResponseStatus(int itemsTotalCount = default(int), int itemsCompletedCount = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateTagRemoveActivity201ResponseStatus {\n");
