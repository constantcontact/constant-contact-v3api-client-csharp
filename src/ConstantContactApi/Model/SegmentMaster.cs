...
namespace ConstantContactApi.Model
{
    ...
    /// SegmentMaster
    /// </summary>
    [DataContract(Name = "SegmentMaster")]
    public partial class SegmentMaster : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SegmentMaster" /> class.
        /// </summary>
        /// <param name="name">The segment&#39;s unique descriptive name..</param>
        public SegmentMaster(string name = default(string))
        {
            this.Name = name;
        }
