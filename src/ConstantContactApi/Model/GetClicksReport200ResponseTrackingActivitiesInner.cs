...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getClicksReport_200_response_tracking_activities_inner")]
    public partial class GetClicksReport200ResponseTrackingActivitiesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetClicksReport200ResponseTrackingActivitiesInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetClicksReport200ResponseTrackingActivitiesInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetClicksReport200ResponseTrackingActivitiesInner" /> class.
        /// </summary>
        ...
        public GetClicksReport200ResponseTrackingActivitiesInner(Guid contactId = default(Guid), Guid campaignActivityId = default(Guid), string trackingActivityType = default(string), string emailAddress = default(string), string firstName = default(string), string lastName = default(string), string deviceType = default(string), string urlId = default(string), string linkUrl = default(string), DateTime createdTime = default(DateTime), DateTime deletedAt = default(DateTime))
        {
            ...
            {
                throw new ArgumentNullException("trackingActivityType is a required property for GetClicksReport200ResponseTrackingActivitiesInner and cannot be null");
            }
            this.TrackingActivityType = trackingActivityType;
            // to ensure "emailAddress" is required (not null)
            if (emailAddress == null)
            {
                throw new ArgumentNullException("emailAddress is a required property for GetClicksReport200ResponseTrackingActivitiesInner and cannot be null");
            }
            this.EmailAddress = emailAddress;
            // to ensure "urlId" is required (not null)
            if (urlId == null)
            {
                throw new ArgumentNullException("urlId is a required property for GetClicksReport200ResponseTrackingActivitiesInner and cannot be null");
            }
            this.UrlId = urlId;
            // to ensure "linkUrl" is required (not null)
            if (linkUrl == null)
            {
                throw new ArgumentNullException("linkUrl is a required property for GetClicksReport200ResponseTrackingActivitiesInner and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetClicksReport200ResponseTrackingActivitiesInner {\n");
