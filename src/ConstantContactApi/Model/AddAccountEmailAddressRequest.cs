...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "addAccountEmailAddress_request")]
    public partial class AddAccountEmailAddressRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddAccountEmailAddressRequest" /> class.
        /// </summary>
        /// <param name="emailAddress">The new email address you want to add to a Constant Contact account..</param>
        public AddAccountEmailAddressRequest(string emailAddress = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddAccountEmailAddressRequest {\n");
