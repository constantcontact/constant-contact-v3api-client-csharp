...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getContactById_200_response_phone_numbers_inner")]
    public partial class GetContactById200ResponsePhoneNumbersInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetContactById200ResponsePhoneNumbersInner" /> class.
        /// </summary>
        ...
        public GetContactById200ResponsePhoneNumbersInner(string phoneNumber = default(string), string kind = default(string), string updateSource = default(string), string createSource = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetContactById200ResponsePhoneNumbersInner {\n");
