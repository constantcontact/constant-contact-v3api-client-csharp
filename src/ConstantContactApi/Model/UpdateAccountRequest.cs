...
namespace ConstantContactApi.Model
{
    ...
    public partial class UpdateAccountRequest : IValidatableObject
    {
        ...
        public UpdateAccountRequest(string contactEmail = default(string), string contactPhone = default(string), string countryCode = default(string), string firstName = default(string), string lastName = default(string), string organizationName = default(string), string organizationPhone = default(string), string stateCode = default(string), string timeZoneId = default(string), string website = default(string))
        {
