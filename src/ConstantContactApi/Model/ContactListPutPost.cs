...
namespace ConstantContactApi.Model
{
    ...
    /// ContactListPutPost
    /// </summary>
    [DataContract(Name = "ContactListPutPost")]
    public partial class ContactListPutPost : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactListPutPost" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ContactListPutPost() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactListPutPost" /> class.
        /// </summary>
        ...
        public ContactListPutPost(string name = default(string), string description = default(string), bool favorite = false)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ContactListPutPost and cannot be null");
            }
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContactListPutPost {\n");
