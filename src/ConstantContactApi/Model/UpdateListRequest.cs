...
namespace ConstantContactApi.Model
{
    ...
    public partial class UpdateListRequest : IValidatableObject
    {
        ...
        public UpdateListRequest(string name = default(string), bool favorite = false, string description = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for UpdateListRequest and cannot be null");
            }
            this.Name = name;
