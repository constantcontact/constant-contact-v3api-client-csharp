...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createResendEmailCampaign_request")]
    public partial class CreateResendEmailCampaignRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateResendEmailCampaignRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateResendEmailCampaignRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateResendEmailCampaignRequest" /> class.
        /// </summary>
        ...
        public CreateResendEmailCampaignRequest(string resendSubject = default(string), int delayDays = default(int), int delayMinutes = default(int))
        {
            // to ensure "resendSubject" is required (not null)
            if (resendSubject == null)
            {
                throw new ArgumentNullException("resendSubject is a required property for CreateResendEmailCampaignRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateResendEmailCampaignRequest {\n");
