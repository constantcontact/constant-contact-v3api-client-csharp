...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PlanTiersObject_current_tiers_inner")]
    public partial class PlanTiersObjectCurrentTiersInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlanTiersObjectCurrentTiersInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public PlanTiersObjectCurrentTiersInner()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlanTiersObjectCurrentTiersInner {\n");
