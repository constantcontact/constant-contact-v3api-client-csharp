...
namespace ConstantContactApi.Model
{
    ...
    /// StreetAddressPut
    /// </summary>
    [DataContract(Name = "StreetAddressPut")]
    public partial class StreetAddressPut : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StreetAddressPut" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StreetAddressPut() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StreetAddressPut" /> class.
        /// </summary>
        ...
        public StreetAddressPut(string kind = default(string), string street = default(string), string city = default(string), string state = default(string), string postalCode = default(string), string country = default(string))
        {
            // to ensure "kind" is required (not null)
            if (kind == null)
            {
                throw new ArgumentNullException("kind is a required property for StreetAddressPut and cannot be null");
            }
            this.Kind = kind;
            this.Street = street;
            this.City = city;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StreetAddressPut {\n");
