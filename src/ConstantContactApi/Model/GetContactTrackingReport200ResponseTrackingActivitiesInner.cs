...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getContactTrackingReport_200_response_tracking_activities_inner")]
    public partial class GetContactTrackingReport200ResponseTrackingActivitiesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetContactTrackingReport200ResponseTrackingActivitiesInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetContactTrackingReport200ResponseTrackingActivitiesInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetContactTrackingReport200ResponseTrackingActivitiesInner" /> class.
        /// </summary>
        ...
        public GetContactTrackingReport200ResponseTrackingActivitiesInner(Guid contactId = default(Guid), Guid campaignActivityId = default(Guid), DateTime createdTime = default(DateTime), string trackingActivityType = default(string), string campaignActivityName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetContactTrackingReport200ResponseTrackingActivitiesInner {\n");
