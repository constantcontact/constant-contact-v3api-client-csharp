...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountPhysicalAddress")]
    public partial class AccountPhysicalAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountPhysicalAddress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountPhysicalAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountPhysicalAddress" /> class.
        /// </summary>
        ...
        public AccountPhysicalAddress(string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string city = default(string), string stateCode = default(string), string stateName = default(string), string postalCode = default(string), string countryCode = default(string))
        {
            // to ensure "addressLine1" is required (not null)
            if (addressLine1 == null)
            {
                throw new ArgumentNullException("addressLine1 is a required property for AccountPhysicalAddress and cannot be null");
            }
            this.AddressLine1 = addressLine1;
            // to ensure "city" is required (not null)
            if (city == null)
            {
                throw new ArgumentNullException("city is a required property for AccountPhysicalAddress and cannot be null");
            }
            this.City = city;
            // to ensure "countryCode" is required (not null)
            if (countryCode == null)
            {
                throw new ArgumentNullException("countryCode is a required property for AccountPhysicalAddress and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountPhysicalAddress {\n");
