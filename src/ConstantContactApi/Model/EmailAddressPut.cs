...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EmailAddressPut")]
    public partial class EmailAddressPut : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailAddressPut" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EmailAddressPut() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailAddressPut" /> class.
        /// </summary>
        ...
        public EmailAddressPut(string address = default(string), string permissionToSend = default(string), string optOutReason = default(string))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for EmailAddressPut and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailAddressPut {\n");
