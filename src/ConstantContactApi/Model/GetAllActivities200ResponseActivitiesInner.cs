...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getAllActivities_200_response_activities_inner")]
    public partial class GetAllActivities200ResponseActivitiesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAllActivities200ResponseActivitiesInner" /> class.
        /// </summary>
        ...
        public GetAllActivities200ResponseActivitiesInner(string state = default(string), List<string> activityErrors = default(List<string>), GetAllActivities200ResponseActivitiesInnerStatus status = default(GetAllActivities200ResponseActivitiesInnerStatus), GetAllActivities200ResponseActivitiesInnerLinks links = default(GetAllActivities200ResponseActivitiesInnerLinks))
        {
            this.State = state;
        ...
        /// </summary>
        /// <value>Name of the file used for an add_contacts activity.</value>
        ...
        public GetAllActivities200ResponseActivitiesInnerStatus Status { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAllActivities200ResponseActivitiesInner {\n");
