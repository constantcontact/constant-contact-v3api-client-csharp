...
namespace ConstantContactApi.Model
{
    ...
    /// SegmentDetail
    /// </summary>
    [DataContract(Name = "SegmentDetail")]
    public partial class SegmentDetail : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SegmentDetail" /> class.
        /// </summary>
        ...
        public SegmentDetail(string name = default(string), string segmentCriteria = default(string))
        {
            this.Name = name;
