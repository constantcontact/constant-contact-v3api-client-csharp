...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getUniqueContactClicks_200_response_tracking_activities_inner_sms_channel")]
    public partial class GetUniqueContactClicks200ResponseTrackingActivitiesInnerSmsChannel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUniqueContactClicks200ResponseTrackingActivitiesInnerSmsChannel" /> class.
        /// </summary>
        ...
        public GetUniqueContactClicks200ResponseTrackingActivitiesInnerSmsChannel(string countryCode = default(string), string state = default(string), string formattedInternational = default(string), string formattedNational = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetUniqueContactClicks200ResponseTrackingActivitiesInnerSmsChannel {\n");
