...
namespace ConstantContactApi.Model
{
    ...
    public partial class Links : IValidatableObject
    {
        ...
        public Links(GetAllSegments200ResponseLinksNext next = default(GetAllSegments200ResponseLinksNext))
        {
            // to ensure "next" is required (not null)
            if (next == null)
            {
                throw new ArgumentNullException("next is a required property for Links and cannot be null");
            }
            this.Next = next;
        }
