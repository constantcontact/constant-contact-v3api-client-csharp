...
namespace ConstantContactApi.Model
{
    ...
    /// EmailCampaigns
    /// </summary>
    [DataContract(Name = "EmailCampaigns")]
    public partial class EmailCampaigns : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailCampaigns" /> class.
        /// </summary>
        ...
        public EmailCampaigns(string campaignId = default(string), string currentStatus = default(string), string name = default(string), string type = default(string), int typeCode = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailCampaigns {\n");
