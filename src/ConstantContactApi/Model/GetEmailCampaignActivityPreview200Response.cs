...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getEmailCampaignActivityPreview_200_response")]
    public partial class GetEmailCampaignActivityPreview200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEmailCampaignActivityPreview200Response" /> class.
        /// </summary>
        ...
        public GetEmailCampaignActivityPreview200Response(string campaignActivityId = default(string), string fromEmail = default(string), string fromName = default(string), string preheader = default(string), string previewHtmlContent = default(string), string previewTextContent = default(string), string replyToEmail = default(string), string subject = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEmailCampaignActivityPreview200Response {\n");
