...
namespace ConstantContactApi.Model
{
    ...
    public partial class EmailAddress : IValidatableObject
    {
        ...
        public EmailAddress(string address = default(string), string permissionToSend = default(string), string optInSource = default(string), string optOutReason = default(string))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for EmailAddress and cannot be null");
            }
