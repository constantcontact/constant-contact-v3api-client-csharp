...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EmailAddressPost")]
    public partial class EmailAddressPost : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailAddressPost" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EmailAddressPost() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailAddressPost" /> class.
        /// </summary>
        ...
        public EmailAddressPost(string address = default(string), string permissionToSend = default(string))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for EmailAddressPost and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailAddressPost {\n");
