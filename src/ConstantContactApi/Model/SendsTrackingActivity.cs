...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SendsTrackingActivity")]
    public partial class SendsTrackingActivity : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendsTrackingActivity" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SendsTrackingActivity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SendsTrackingActivity" /> class.
        /// </summary>
        ...
        public SendsTrackingActivity(Guid contactId = default(Guid), Guid campaignActivityId = default(Guid), string trackingActivityType = default(string), string emailAddress = default(string), string firstName = default(string), string lastName = default(string), DateTime createdTime = default(DateTime), DateTime deletedAt = default(DateTime))
        {
            ...
            {
                throw new ArgumentNullException("trackingActivityType is a required property for SendsTrackingActivity and cannot be null");
            }
            this.TrackingActivityType = trackingActivityType;
            // to ensure "emailAddress" is required (not null)
            if (emailAddress == null)
            {
                throw new ArgumentNullException("emailAddress is a required property for SendsTrackingActivity and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SendsTrackingActivity {\n");
