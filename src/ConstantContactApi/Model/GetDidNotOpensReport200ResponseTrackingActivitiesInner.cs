...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getDidNotOpensReport_200_response_tracking_activities_inner")]
    public partial class GetDidNotOpensReport200ResponseTrackingActivitiesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDidNotOpensReport200ResponseTrackingActivitiesInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetDidNotOpensReport200ResponseTrackingActivitiesInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDidNotOpensReport200ResponseTrackingActivitiesInner" /> class.
        /// </summary>
        ...
        public GetDidNotOpensReport200ResponseTrackingActivitiesInner(Guid contactId = default(Guid), Guid campaignActivityId = default(Guid), string trackingActivityType = default(string), string emailAddress = default(string), string firstName = default(string), string lastName = default(string), DateTime createdTime = default(DateTime), DateTime deletedAt = default(DateTime))
        {
            ...
            {
                throw new ArgumentNullException("trackingActivityType is a required property for GetDidNotOpensReport200ResponseTrackingActivitiesInner and cannot be null");
            }
            this.TrackingActivityType = trackingActivityType;
            // to ensure "emailAddress" is required (not null)
            if (emailAddress == null)
            {
                throw new ArgumentNullException("emailAddress is a required property for GetDidNotOpensReport200ResponseTrackingActivitiesInner and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetDidNotOpensReport200ResponseTrackingActivitiesInner {\n");
