...
namespace ConstantContactApi.Model
{
    ...
    /// JmmlSmsChannel
    /// </summary>
    [DataContract(Name = "JmmlSmsChannel")]
    public partial class JmmlSmsChannel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JmmlSmsChannel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected JmmlSmsChannel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="JmmlSmsChannel" /> class.
        /// </summary>
        ...
        public JmmlSmsChannel(string smsAddress = default(string), string dialCode = default(string), string countryCode = default(string), List<JmmlSmsChannelSmsChannelConsentsInner> smsChannelConsents = default(List<JmmlSmsChannelSmsChannelConsentsInner>))
        {
            // to ensure "smsAddress" is required (not null)
            if (smsAddress == null)
            {
                throw new ArgumentNullException("smsAddress is a required property for JmmlSmsChannel and cannot be null");
            }
            this.SmsAddress = smsAddress;
            // to ensure "dialCode" is required (not null)
            if (dialCode == null)
            {
                throw new ArgumentNullException("dialCode is a required property for JmmlSmsChannel and cannot be null");
            }
            this.DialCode = dialCode;
            // to ensure "countryCode" is required (not null)
            if (countryCode == null)
            {
                throw new ArgumentNullException("countryCode is a required property for JmmlSmsChannel and cannot be null");
            }
            this.CountryCode = countryCode;
            // to ensure "smsChannelConsents" is required (not null)
            if (smsChannelConsents == null)
            {
                throw new ArgumentNullException("smsChannelConsents is a required property for JmmlSmsChannel and cannot be null");
            }
        ...
        public List<JmmlSmsChannelSmsChannelConsentsInner> SmsChannelConsents { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JmmlSmsChannel {\n");
