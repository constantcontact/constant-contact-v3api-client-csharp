...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OpensTrackingActivity")]
    public partial class OpensTrackingActivity : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpensTrackingActivity" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OpensTrackingActivity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OpensTrackingActivity" /> class.
        /// </summary>
        ...
        public OpensTrackingActivity(Guid contactId = default(Guid), Guid campaignActivityId = default(Guid), string trackingActivityType = default(string), string emailAddress = default(string), string firstName = default(string), string lastName = default(string), string deviceType = default(string), DateTime createdTime = default(DateTime), DateTime deletedAt = default(DateTime))
        {
            ...
            {
                throw new ArgumentNullException("trackingActivityType is a required property for OpensTrackingActivity and cannot be null");
            }
            this.TrackingActivityType = trackingActivityType;
            // to ensure "emailAddress" is required (not null)
            if (emailAddress == null)
            {
                throw new ArgumentNullException("emailAddress is a required property for OpensTrackingActivity and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OpensTrackingActivity {\n");
