...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ActivityDeleteStatus")]
    public partial class ActivityDeleteStatus : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActivityDeleteStatus" /> class.
        /// </summary>
        ...
        public ActivityDeleteStatus(string state = default(string), List<string> activityErrors = default(List<string>), CreateDeleteActivity201ResponseStatus status = default(CreateDeleteActivity201ResponseStatus), CreateDeleteActivity201ResponseLinks links = default(CreateDeleteActivity201ResponseLinks))
        {
            this.State = state;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActivityDeleteStatus {\n");
