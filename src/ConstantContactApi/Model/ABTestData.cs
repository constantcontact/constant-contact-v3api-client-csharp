...
namespace ConstantContactApi.Model
{
    ...
    /// ABTestData
    /// </summary>
    [DataContract(Name = "ABTestData")]
    public partial class ABTestData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ABTestData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ABTestData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ABTestData" /> class.
        /// </summary>
        ...
        public ABTestData(string alternativeSubject = default(string), int testSize = default(int), int winnerWaitDuration = default(int))
        {
            // to ensure "alternativeSubject" is required (not null)
            if (alternativeSubject == null)
            {
                throw new ArgumentNullException("alternativeSubject is a required property for ABTestData and cannot be null");
            }
