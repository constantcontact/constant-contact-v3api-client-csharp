...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createImportJSONActivity_request")]
    public partial class CreateImportJSONActivityRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateImportJSONActivityRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateImportJSONActivityRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateImportJSONActivityRequest" /> class.
        /// </summary>
        ...
        public CreateImportJSONActivityRequest(List<CreateImportJSONActivityRequestImportDataInner> importData = default(List<CreateImportJSONActivityRequestImportDataInner>), List<Guid> listIds = default(List<Guid>), string smsPermissionToSend = default(string))
        {
            // to ensure "importData" is required (not null)
            if (importData == null)
            {
                throw new ArgumentNullException("importData is a required property for CreateImportJSONActivityRequest and cannot be null");
            }
            this.ImportData = importData;
            // to ensure "listIds" is required (not null)
            if (listIds == null)
            {
                throw new ArgumentNullException("listIds is a required property for CreateImportJSONActivityRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateImportJSONActivityRequest {\n");
