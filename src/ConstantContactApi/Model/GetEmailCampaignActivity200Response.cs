...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getEmailCampaignActivity_200_response")]
    public partial class GetEmailCampaignActivity200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEmailCampaignActivity200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetEmailCampaignActivity200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEmailCampaignActivity200Response" /> class.
        /// </summary>
        ...
        public GetEmailCampaignActivity200Response(List<string> contactListIds = default(List<string>), List<int> segmentIds = default(List<int>), string fromEmail = default(string), string fromName = default(string), string replyToEmail = default(string), string subject = default(string), string htmlContent = default(string), string preheader = default(string), GetEmailCampaignActivity200ResponsePhysicalAddressInFooter physicalAddressInFooter = default(GetEmailCampaignActivity200ResponsePhysicalAddressInFooter), GetEmailCampaignActivity200ResponseDocumentProperties documentProperties = default(GetEmailCampaignActivity200ResponseDocumentProperties))
        {
            // to ensure "fromEmail" is required (not null)
            if (fromEmail == null)
            {
                throw new ArgumentNullException("fromEmail is a required property for GetEmailCampaignActivity200Response and cannot be null");
            }
            this.FromEmail = fromEmail;
            // to ensure "fromName" is required (not null)
            if (fromName == null)
            {
                throw new ArgumentNullException("fromName is a required property for GetEmailCampaignActivity200Response and cannot be null");
            }
            this.FromName = fromName;
            // to ensure "replyToEmail" is required (not null)
            if (replyToEmail == null)
            {
                throw new ArgumentNullException("replyToEmail is a required property for GetEmailCampaignActivity200Response and cannot be null");
            }
            this.ReplyToEmail = replyToEmail;
            // to ensure "subject" is required (not null)
            if (subject == null)
            {
                throw new ArgumentNullException("subject is a required property for GetEmailCampaignActivity200Response and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEmailCampaignActivity200Response {\n");
