...
namespace ConstantContactApi.Model
{
    ...
    /// CustomerPut
    /// </summary>
    [DataContract(Name = "CustomerPut")]
    public partial class CustomerPut : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerPut" /> class.
        /// </summary>
        /// <param name="contactEmail">The confirmed email address that is associated with the account owner..</param>
        /// <param name="contactPhone">The account owner&#39;s contact phone number (up to 25 characters in length)..</param>
        /// <param name="countryCode">The two-letter &lt;a href&#x3D;&#39;https://en.wikipedia.org/wiki/ISO_3166-1&#39; target&#x3D;&#39;_blank&#39;&gt;ISO 3166-1 code&lt;/a&gt; representing the organization&#39;s country..</param>
        ...
        /// <param name="stateCode">The two letter &lt;a href&#x3D;&#39;https://en.wikipedia.org/wiki/ISO_3166-1&#39; target&#x3D;&#39;_blank&#39;&gt;ISO 3166-1 code&lt;/a&gt; used to specify the state to associate with the account. This property is required if the &lt;code&gt;country_code&lt;/code&gt; is US (United States)..</param>
        /// <param name="timeZoneId">The time zone to use for the account; as defined in the IANA time-zone database (see http://www.iana.org/time-zones)..</param>
        /// <param name="website">The organization&#39;s website URL..</param>
        public CustomerPut(string contactEmail = default(string), string contactPhone = default(string), string countryCode = default(string), string firstName = default(string), string lastName = default(string), string organizationName = default(string), string organizationPhone = default(string), string stateCode = default(string), string timeZoneId = default(string), string website = default(string))
        {
        ...
        /// </summary>
        /// <value>The confirmed email address that is associated with the account owner.</value>
        ...
        /// </summary>
        /// <value>The two-letter &lt;a href&#x3D;&#39;https://en.wikipedia.org/wiki/ISO_3166-1&#39; target&#x3D;&#39;_blank&#39;&gt;ISO 3166-1 code&lt;/a&gt; representing the organization&#39;s country.</value>
        /// <example>US</example>
        ...
        /// </summary>
        /// <value>The read only encoded account ID that uniquely identifies the account.</value>
        ...
        /// </summary>
        /// <value>The two letter &lt;a href&#x3D;&#39;https://en.wikipedia.org/wiki/ISO_3166-1&#39; target&#x3D;&#39;_blank&#39;&gt;ISO 3166-1 code&lt;/a&gt; used to specify the state to associate with the account. This property is required if the &lt;code&gt;country_code&lt;/code&gt; is US (United States).</value>
        /// <example>MA</example>
        ...
        /// </summary>
        /// <value>The time zone to use for the account; as defined in the IANA time-zone database (see http://www.iana.org/time-zones).</value>
