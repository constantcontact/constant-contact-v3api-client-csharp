...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getOptoutsReport_200_response_tracking_activities_inner")]
    public partial class GetOptoutsReport200ResponseTrackingActivitiesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOptoutsReport200ResponseTrackingActivitiesInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetOptoutsReport200ResponseTrackingActivitiesInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOptoutsReport200ResponseTrackingActivitiesInner" /> class.
        /// </summary>
        ...
        /// <param name="optOutReason">The opt-out reason, if the contact entered a reason..</param>
        /// <param name="createdTime">The time that the contact chose to opt-out from receiving future email campaign activities. (required).</param>
        /// <param name="deletedAt">If applicable, displays the date that the contact was deleted..</param>
        public GetOptoutsReport200ResponseTrackingActivitiesInner(Guid contactId = default(Guid), Guid campaignActivityId = default(Guid), string trackingActivityType = default(string), string emailAddress = default(string), string firstName = default(string), string lastName = default(string), string optOutReason = default(string), DateTime createdTime = default(DateTime), DateTime deletedAt = default(DateTime))
        {
            ...
            {
                throw new ArgumentNullException("trackingActivityType is a required property for GetOptoutsReport200ResponseTrackingActivitiesInner and cannot be null");
            }
            this.TrackingActivityType = trackingActivityType;
            // to ensure "emailAddress" is required (not null)
            if (emailAddress == null)
            {
                throw new ArgumentNullException("emailAddress is a required property for GetOptoutsReport200ResponseTrackingActivitiesInner and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The opt-out reason, if the contact entered a reason.</value>
        /// <example>The content is not what I expected</example>
        ...
        /// </summary>
        /// <value>The time that the contact chose to opt-out from receiving future email campaign activities.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetOptoutsReport200ResponseTrackingActivitiesInner {\n");
