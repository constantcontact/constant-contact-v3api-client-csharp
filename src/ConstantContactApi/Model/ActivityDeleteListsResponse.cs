...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ActivityDeleteListsResponse")]
    public partial class ActivityDeleteListsResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActivityDeleteListsResponse" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        /// <param name="links">links.</param>
        public ActivityDeleteListsResponse(CreateListDeleteActivity201ResponseStatus status = default(CreateListDeleteActivity201ResponseStatus), CreateListDeleteActivity201ResponseLinks links = default(CreateListDeleteActivity201ResponseLinks))
        {
            this.Status = status;
            this.Links = links;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActivityDeleteListsResponse {\n");
