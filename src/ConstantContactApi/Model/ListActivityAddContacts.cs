...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListActivityAddContacts")]
    public partial class ListActivityAddContacts : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListActivityAddContacts" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListActivityAddContacts() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListActivityAddContacts" /> class.
        /// </summary>
        ...
        public ListActivityAddContacts(CreateListAddActivityRequestSource source = default(CreateListAddActivityRequestSource), CreateListAddActivityRequestExclude exclude = default(CreateListAddActivityRequestExclude), List<Guid> listIds = default(List<Guid>))
        {
            // to ensure "source" is required (not null)
            if (source == null)
            {
                throw new ArgumentNullException("source is a required property for ListActivityAddContacts and cannot be null");
            }
            this.Source = source;
            // to ensure "listIds" is required (not null)
            if (listIds == null)
            {
                throw new ArgumentNullException("listIds is a required property for ListActivityAddContacts and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListActivityAddContacts {\n");
