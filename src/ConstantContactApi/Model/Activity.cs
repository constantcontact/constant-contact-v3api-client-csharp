...
namespace ConstantContactApi.Model
{
    ...
    public partial class Activity : IValidatableObject
    {
        ...
        public Activity(string state = default(string), List<string> activityErrors = default(List<string>), GetAllActivities200ResponseActivitiesInnerStatus status = default(GetAllActivities200ResponseActivitiesInnerStatus), GetAllActivities200ResponseActivitiesInnerLinks links = default(GetAllActivities200ResponseActivitiesInnerLinks))
        {
            this.State = state;
