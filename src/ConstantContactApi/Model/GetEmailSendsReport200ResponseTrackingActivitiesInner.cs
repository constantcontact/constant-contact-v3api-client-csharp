...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getEmailSendsReport_200_response_tracking_activities_inner")]
    public partial class GetEmailSendsReport200ResponseTrackingActivitiesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEmailSendsReport200ResponseTrackingActivitiesInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetEmailSendsReport200ResponseTrackingActivitiesInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEmailSendsReport200ResponseTrackingActivitiesInner" /> class.
        /// </summary>
        ...
        public GetEmailSendsReport200ResponseTrackingActivitiesInner(Guid contactId = default(Guid), Guid campaignActivityId = default(Guid), string trackingActivityType = default(string), string emailAddress = default(string), string firstName = default(string), string lastName = default(string), DateTime createdTime = default(DateTime), DateTime deletedAt = default(DateTime))
        {
            ...
            {
                throw new ArgumentNullException("trackingActivityType is a required property for GetEmailSendsReport200ResponseTrackingActivitiesInner and cannot be null");
            }
            this.TrackingActivityType = trackingActivityType;
            // to ensure "emailAddress" is required (not null)
            if (emailAddress == null)
            {
                throw new ArgumentNullException("emailAddress is a required property for GetEmailSendsReport200ResponseTrackingActivitiesInner and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The date and time that you sent the email campaign to the contact.</value>
        ...
        /// <example>Tue Apr 09 20:00:00 EDT 2019</example>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEmailSendsReport200ResponseTrackingActivitiesInner {\n");
