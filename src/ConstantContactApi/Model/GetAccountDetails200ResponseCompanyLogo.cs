...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getAccountDetails_200_response_company_logo")]
    public partial class GetAccountDetails200ResponseCompanyLogo : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAccountDetails200ResponseCompanyLogo" /> class.
        /// </summary>
        ...
        public GetAccountDetails200ResponseCompanyLogo(string url = default(string), string externalUrl = default(string), string internalId = default(string))
        {
            this.Url = url;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAccountDetails200ResponseCompanyLogo {\n");
