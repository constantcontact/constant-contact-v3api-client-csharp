...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ActivityDeleteCustomFields")]
    public partial class ActivityDeleteCustomFields : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActivityDeleteCustomFields" /> class.
        /// </summary>
        ...
        public ActivityDeleteCustomFields(string state = default(string), List<string> activityErrors = default(List<string>), CreateDeleteActivity201ResponseLinks links = default(CreateDeleteActivity201ResponseLinks))
        {
            this.State = state;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActivityDeleteCustomFields {\n");
