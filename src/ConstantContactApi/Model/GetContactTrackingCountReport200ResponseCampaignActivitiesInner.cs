...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getContactTrackingCountReport_200_response_campaign_activities_inner")]
    public partial class GetContactTrackingCountReport200ResponseCampaignActivitiesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetContactTrackingCountReport200ResponseCampaignActivitiesInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetContactTrackingCountReport200ResponseCampaignActivitiesInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetContactTrackingCountReport200ResponseCampaignActivitiesInner" /> class.
        /// </summary>
        ...
        public GetContactTrackingCountReport200ResponseCampaignActivitiesInner(Guid campaignActivityId = default(Guid), DateTime startOn = default(DateTime), int emBounces = default(int), int emClicks = default(int), int emForwards = default(int), int emOpens = default(int), int emSends = default(int), int emUnsubscribes = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetContactTrackingCountReport200ResponseCampaignActivitiesInner {\n");
