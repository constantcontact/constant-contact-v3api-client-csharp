...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "testSendEmailCampaignActivity_request")]
    public partial class TestSendEmailCampaignActivityRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestSendEmailCampaignActivityRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TestSendEmailCampaignActivityRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TestSendEmailCampaignActivityRequest" /> class.
        /// </summary>
        ...
        public TestSendEmailCampaignActivityRequest(List<string> emailAddresses = default(List<string>), string personalMessage = default(string))
        {
            // to ensure "emailAddresses" is required (not null)
            if (emailAddresses == null)
            {
                throw new ArgumentNullException("emailAddresses is a required property for TestSendEmailCampaignActivityRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TestSendEmailCampaignActivityRequest {\n");
