...
namespace ConstantContactApi.Model
{
    ...
    public partial class ContactList : IValidatableObject
    {
        ...
        public ContactList(string name = default(string), string description = default(string), bool favorite = false)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ContactList and cannot be null");
            }
            this.Name = name;
