...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getAccountDetails_200_response")]
    public partial class GetAccountDetails200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAccountDetails200Response" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>The encoded partner id that identifies which Constant Contact partner provisioned the account.</value>
        /// <example>a37cranviy95el</example>
        [DataMember(Name = "encoded_partner_id", EmitDefaultValue = false)]
        public string EncodedPartnerId { get; private set; }

        /// <summary>
        /// Returns false as EncodedPartnerId should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeEncodedPartnerId()
        {
            return false;
        }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAccountDetails200Response {\n");
            sb.Append("  ContactEmail: ").Append(ContactEmail).Append("\n");
            sb.Append("  ContactPhone: ").Append(ContactPhone).Append("\n");
            sb.Append("  CountryCode: ").Append(CountryCode).Append("\n");
            sb.Append("  EncodedAccountId: ").Append(EncodedAccountId).Append("\n");
            sb.Append("  EncodedPartnerId: ").Append(EncodedPartnerId).Append("\n");
