...
namespace ConstantContactApi.Model
{
    ...
    public partial class CreateEmailCampaignRequest : IValidatableObject
    {
        ...
        protected CreateEmailCampaignRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateEmailCampaignRequest" /> class.
        /// </summary>
        ...
        public CreateEmailCampaignRequest(string name = default(string), List<CreateEmailCampaignRequestEmailCampaignActivitiesInner> emailCampaignActivities = default(List<CreateEmailCampaignRequestEmailCampaignActivitiesInner>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateEmailCampaignRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "emailCampaignActivities" is required (not null)
            if (emailCampaignActivities == null)
            {
                throw new ArgumentNullException("emailCampaignActivities is a required property for CreateEmailCampaignRequest and cannot be null");
            }
