...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createExportActivity_request")]
    public partial class CreateExportActivityRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateExportActivityRequest" /> class.
        /// </summary>
        ...
        public CreateExportActivityRequest(List<Guid> contactIds = default(List<Guid>), List<Guid> listIds = default(List<Guid>), List<Guid> tagIds = default(List<Guid>), bool newSubscriber = default(bool), int segmentId = default(int), List<string> fields = default(List<string>), string status = default(string), CreateExportActivityRequestExclude exclude = default(CreateExportActivityRequestExclude))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateExportActivityRequest {\n");
