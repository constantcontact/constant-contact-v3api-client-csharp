...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getContactCounts_200_response")]
    public partial class GetContactCounts200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetContactCounts200Response" /> class.
        /// </summary>
        ...
        public GetContactCounts200Response(int total = default(int), int varExplicit = default(int), int varImplicit = default(int), int pending = default(int), int unsubscribed = default(int), int newSubscriber = default(int))
        {
            this.Total = total;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetContactCounts200Response {\n");
