...
namespace ConstantContactApi.Model
{
    ...
    /// TagPost
    /// </summary>
    [DataContract(Name = "TagPost")]
    public partial class TagPost : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagPost" /> class.
        /// </summary>
        ...
        public TagPost(string name = default(string), string tagSource = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for TagPost and cannot be null");
            }
            this.Name = name;
