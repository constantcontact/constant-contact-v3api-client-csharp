...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CampaignStatsResultGenericStatsEmailPercentsEmail")]
    public partial class CampaignStatsResultGenericStatsEmailPercentsEmail : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CampaignStatsResultGenericStatsEmailPercentsEmail" /> class.
        /// </summary>
        ...
        public CampaignStatsResultGenericStatsEmailPercentsEmail(string campaignId = default(string), GetEmailStatsReport200ResponseResultsInnerStats stats = default(GetEmailStatsReport200ResponseResultsInnerStats), GetEmailStatsReport200ResponseResultsInnerPercents percents = default(GetEmailStatsReport200ResponseResultsInnerPercents), DateTime lastRefreshTime = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CampaignStatsResultGenericStatsEmailPercentsEmail {\n");
