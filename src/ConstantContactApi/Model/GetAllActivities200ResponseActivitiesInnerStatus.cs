...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getAllActivities_200_response_activities_inner_status")]
    public partial class GetAllActivities200ResponseActivitiesInnerStatus : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAllActivities200ResponseActivitiesInnerStatus" /> class.
        /// </summary>
        ...
        public GetAllActivities200ResponseActivitiesInnerStatus(int correctableCount = default(int), int cannotAddToListCount = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAllActivities200ResponseActivitiesInnerStatus {\n");
