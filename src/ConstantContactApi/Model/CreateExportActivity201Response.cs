...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createExportActivity_201_response")]
    public partial class CreateExportActivity201Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateExportActivity201Response" /> class.
        /// </summary>
        /// <param name="state">&lt;p&gt; The state of the request: &lt;ul&gt;  &lt;li&gt;initialized - request has been received&lt;/li&gt;  &lt;li&gt;processing - request is being processed&lt;/li&gt;  &lt;li&gt;completed - job completed&lt;/li&gt;  &lt;li&gt;cancelled - request was cancelled&lt;/li&gt;  &lt;li&gt;failed - job failed to complete&lt;/li&gt;  &lt;li&gt;timed_out - the request timed out before completing\&quot;&lt;/li&gt;  &lt;/ul&gt; &lt;/p&gt;.</param>
        /// <param name="activityErrors">Array of messages describing the errors that occurred..</param>
        /// <param name="status">status.</param>
        /// <param name="links">links.</param>
        public CreateExportActivity201Response(string state = default(string), List<string> activityErrors = default(List<string>), CreateExportActivity201ResponseStatus status = default(CreateExportActivity201ResponseStatus), GetAllActivities200ResponseActivitiesInnerLinks links = default(GetAllActivities200ResponseActivitiesInnerLinks))
        {
            this.State = state;
        ...
        /// </summary>
        /// <value>&lt;p&gt; The state of the request: &lt;ul&gt;  &lt;li&gt;initialized - request has been received&lt;/li&gt;  &lt;li&gt;processing - request is being processed&lt;/li&gt;  &lt;li&gt;completed - job completed&lt;/li&gt;  &lt;li&gt;cancelled - request was cancelled&lt;/li&gt;  &lt;li&gt;failed - job failed to complete&lt;/li&gt;  &lt;li&gt;timed_out - the request timed out before completing\&quot;&lt;/li&gt;  &lt;/ul&gt; &lt;/p&gt;</value>
        ...
        public CreateExportActivity201ResponseStatus Status { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name = "_links", EmitDefaultValue = false)]
        public GetAllActivities200ResponseActivitiesInnerLinks Links { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateExportActivity201Response {\n");
