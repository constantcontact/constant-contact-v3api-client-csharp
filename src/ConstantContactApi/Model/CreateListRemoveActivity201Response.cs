...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createListRemoveActivity_201_response")]
    public partial class CreateListRemoveActivity201Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateListRemoveActivity201Response" /> class.
        /// </summary>
        ...
        public CreateListRemoveActivity201Response(string state = default(string), List<string> activityErrors = default(List<string>), CreateListRemoveActivity201ResponseStatus status = default(CreateListRemoveActivity201ResponseStatus), CreateCSVImportActivity201ResponseLinks links = default(CreateCSVImportActivity201ResponseLinks))
        {
            this.State = state;
        ...
        public CreateListRemoveActivity201ResponseStatus Status { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateListRemoveActivity201Response {\n");
