...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createEmailCampaign_request_email_campaign_activities_inner")]
    public partial class CreateEmailCampaignRequestEmailCampaignActivitiesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateEmailCampaignRequestEmailCampaignActivitiesInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateEmailCampaignRequestEmailCampaignActivitiesInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateEmailCampaignRequestEmailCampaignActivitiesInner" /> class.
        /// </summary>
        ...
        public CreateEmailCampaignRequestEmailCampaignActivitiesInner(int formatType = default(int), string fromName = default(string), string fromEmail = default(string), string replyToEmail = default(string), string subject = default(string), string preheader = default(string), string htmlContent = default(string), CreateEmailCampaignRequestEmailCampaignActivitiesInnerPhysicalAddressInFooter physicalAddressInFooter = default(CreateEmailCampaignRequestEmailCampaignActivitiesInnerPhysicalAddressInFooter))
        {
            this.FormatType = formatType;
            // to ensure "fromName" is required (not null)
            if (fromName == null)
            {
                throw new ArgumentNullException("fromName is a required property for CreateEmailCampaignRequestEmailCampaignActivitiesInner and cannot be null");
            }
            this.FromName = fromName;
            // to ensure "fromEmail" is required (not null)
            if (fromEmail == null)
            {
                throw new ArgumentNullException("fromEmail is a required property for CreateEmailCampaignRequestEmailCampaignActivitiesInner and cannot be null");
            }
            this.FromEmail = fromEmail;
            // to ensure "replyToEmail" is required (not null)
            if (replyToEmail == null)
            {
                throw new ArgumentNullException("replyToEmail is a required property for CreateEmailCampaignRequestEmailCampaignActivitiesInner and cannot be null");
            }
            this.ReplyToEmail = replyToEmail;
            // to ensure "subject" is required (not null)
            if (subject == null)
            {
                throw new ArgumentNullException("subject is a required property for CreateEmailCampaignRequestEmailCampaignActivitiesInner and cannot be null");
            }
            this.Subject = subject;
            // to ensure "htmlContent" is required (not null)
            if (htmlContent == null)
            {
                throw new ArgumentNullException("htmlContent is a required property for CreateEmailCampaignRequestEmailCampaignActivitiesInner and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateEmailCampaignRequestEmailCampaignActivitiesInner {\n");
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Preheader (string) maxLength
            if (this.Preheader != null && this.Preheader.Length > 200)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Preheader, length must be less than 200.", new [] { "Preheader" });
            }
