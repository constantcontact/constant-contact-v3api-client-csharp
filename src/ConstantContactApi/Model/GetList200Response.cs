...
namespace ConstantContactApi.Model
{
    ...
    /// GetList200Response
    /// </summary>
    [DataContract(Name = "getList_200_response")]
    public partial class GetList200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetList200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetList200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetList200Response" /> class.
        /// </summary>
        ...
        public GetList200Response(string name = default(string), string description = default(string), bool favorite = false)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for GetList200Response and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        /// <value>The total number of contacts that are members in a list. Does not apply to segment type lists.</value>
        /// <example>327</example>
        [DataMember(Name = "membership_count", EmitDefaultValue = false)]
        public int MembershipCount { get; private set; }

        /// <summary>
        /// Returns false as MembershipCount should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeMembershipCount()
        {
            return false;
        }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetList200Response {\n");
            ...
            sb.Append("  MembershipCount: ").Append(MembershipCount).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
