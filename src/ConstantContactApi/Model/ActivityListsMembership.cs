...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ActivityListsMembership")]
    public partial class ActivityListsMembership : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActivityListsMembership" /> class.
        /// </summary>
        ...
        public ActivityListsMembership(string state = default(string), List<string> activityErrors = default(List<string>), CreateListRemoveActivity201ResponseStatus status = default(CreateListRemoveActivity201ResponseStatus), CreateCSVImportActivity201ResponseLinks links = default(CreateCSVImportActivity201ResponseLinks))
        {
            this.State = state;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActivityListsMembership {\n");
