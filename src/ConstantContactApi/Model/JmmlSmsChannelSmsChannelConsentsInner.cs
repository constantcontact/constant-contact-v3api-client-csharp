...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "JmmlSmsChannel_sms_channel_consents_inner")]
    public partial class JmmlSmsChannelSmsChannelConsentsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JmmlSmsChannelSmsChannelConsentsInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected JmmlSmsChannelSmsChannelConsentsInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="JmmlSmsChannelSmsChannelConsentsInner" /> class.
        /// </summary>
        ...
        public JmmlSmsChannelSmsChannelConsentsInner(string smsConsentPermission = default(string), string consentType = default(string), string consentMediumType = default(string), string consentMediumUrl = default(string), string consentMediumDetails = default(string), int advertisedFrequency = default(int), string advertisedInterval = default(string))
        {
            // to ensure "smsConsentPermission" is required (not null)
            if (smsConsentPermission == null)
            {
                throw new ArgumentNullException("smsConsentPermission is a required property for JmmlSmsChannelSmsChannelConsentsInner and cannot be null");
            }
            this.SmsConsentPermission = smsConsentPermission;
            // to ensure "consentType" is required (not null)
            if (consentType == null)
            {
                throw new ArgumentNullException("consentType is a required property for JmmlSmsChannelSmsChannelConsentsInner and cannot be null");
            }
            this.ConsentType = consentType;
            // to ensure "consentMediumType" is required (not null)
            if (consentMediumType == null)
            {
                throw new ArgumentNullException("consentMediumType is a required property for JmmlSmsChannelSmsChannelConsentsInner and cannot be null");
            }
            this.ConsentMediumType = consentMediumType;
            // to ensure "consentMediumUrl" is required (not null)
            if (consentMediumUrl == null)
            {
                throw new ArgumentNullException("consentMediumUrl is a required property for JmmlSmsChannelSmsChannelConsentsInner and cannot be null");
            }
            this.ConsentMediumUrl = consentMediumUrl;
            // to ensure "consentMediumDetails" is required (not null)
            if (consentMediumDetails == null)
            {
                throw new ArgumentNullException("consentMediumDetails is a required property for JmmlSmsChannelSmsChannelConsentsInner and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JmmlSmsChannelSmsChannelConsentsInner {\n");
