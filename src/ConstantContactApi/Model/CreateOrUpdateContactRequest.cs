...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createOrUpdateContact_request")]
    public partial class CreateOrUpdateContactRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOrUpdateContactRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateOrUpdateContactRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateOrUpdateContactRequest" /> class.
        /// </summary>
        ...
        /// <param name="smsChannel">The contact&#39;s SMS compatible phone number..</param>
        public CreateOrUpdateContactRequest(string emailAddress = default(string), string firstName = default(string), string lastName = default(string), string jobTitle = default(string), string companyName = default(string), string phoneNumber = default(string), List<Guid> listMemberships = default(List<Guid>), List<CreateOrUpdateContactRequestCustomFieldsInner> customFields = default(List<CreateOrUpdateContactRequestCustomFieldsInner>), string anniversary = default(string), int birthdayMonth = default(int), int birthdayDay = default(int), CreateOrUpdateContactRequestStreetAddress streetAddress = default(CreateOrUpdateContactRequestStreetAddress), string smsChannel = default(string))
        {
            // to ensure "listMemberships" is required (not null)
            if (listMemberships == null)
            {
                throw new ArgumentNullException("listMemberships is a required property for CreateOrUpdateContactRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The contact&#39;s SMS compatible phone number.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateOrUpdateContactRequest {\n");
