...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createDeleteActivity_201_response")]
    public partial class CreateDeleteActivity201Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDeleteActivity201Response" /> class.
        /// </summary>
        ...
        public CreateDeleteActivity201Response(string state = default(string), List<string> activityErrors = default(List<string>), CreateDeleteActivity201ResponseStatus status = default(CreateDeleteActivity201ResponseStatus), CreateDeleteActivity201ResponseLinks links = default(CreateDeleteActivity201ResponseLinks))
        {
            this.State = state;
        ...
        public CreateDeleteActivity201ResponseStatus Status { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name = "_links", EmitDefaultValue = false)]
        public CreateDeleteActivity201ResponseLinks Links { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateDeleteActivity201Response {\n");
