...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createResendEmailCampaign_201_response")]
    public partial class CreateResendEmailCampaign201Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateResendEmailCampaign201Response" /> class.
        /// </summary>
        ...
        public CreateResendEmailCampaign201Response(string resendSubject = default(string), int delayDays = default(int), int delayMinutes = default(int), string resendRequestId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateResendEmailCampaign201Response {\n");
