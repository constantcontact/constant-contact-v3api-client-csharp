...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createSegment_request")]
    public partial class CreateSegmentRequest : IValidatableObject
    {
        ...
        public CreateSegmentRequest(string name = default(string), string segmentCriteria = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateSegmentRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "segmentCriteria" is required (not null)
            if (segmentCriteria == null)
            {
                throw new ArgumentNullException("segmentCriteria is a required property for CreateSegmentRequest and cannot be null");
            }
