...
namespace ConstantContactApi.Model
{
    ...
    /// UniqueEmailCounts
    /// </summary>
    [DataContract(Name = "UniqueEmailCounts")]
    public partial class UniqueEmailCounts : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniqueEmailCounts" /> class.
        /// </summary>
        /// <param name="sends">The total number of unique sends..</param>
        /// <param name="opens">The total number of unique opens..</param>
        /// <param name="clicks">The total number of unique clicks..</param>
        /// <param name="forwards">The total number of unique forwards..</param>
        /// <param name="optouts">The total number of unique optouts (unsubscribes)..</param>
        /// <param name="abuse">The total number of unique abuse count (spam)..</param>
        /// <param name="bounces">The total number of unique bounce count..</param>
        /// <param name="notOpened">The total number of unique non-opens.</param>
        public UniqueEmailCounts(int sends = default(int), int opens = default(int), int clicks = default(int), int forwards = default(int), int optouts = default(int), int abuse = default(int), int bounces = default(int), int notOpened = default(int))
        {
            this.Sends = sends;
            this.Opens = opens;
            this.Clicks = clicks;
        ...
        /// <example>1</example>
        [DataMember(Name = "abuse", EmitDefaultValue = false)]
        ...
        [DataMember(Name = "not_opened", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UniqueEmailCounts {\n");
