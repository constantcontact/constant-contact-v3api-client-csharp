...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createEmailCampaign_200_response_campaign_activities_inner")]
    public partial class CreateEmailCampaign200ResponseCampaignActivitiesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateEmailCampaign200ResponseCampaignActivitiesInner" /> class.
        /// </summary>
        ...
        public CreateEmailCampaign200ResponseCampaignActivitiesInner(string campaignActivityId = default(string), string role = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateEmailCampaign200ResponseCampaignActivitiesInner {\n");
