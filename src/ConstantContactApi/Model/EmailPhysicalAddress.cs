...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EmailPhysicalAddress")]
    public partial class EmailPhysicalAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailPhysicalAddress" /> class.
        /// </summary>
        ...
        public EmailPhysicalAddress(string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string addressOptional = default(string), string city = default(string), string countryCode = default(string), string organizationName = default(string), string postalCode = default(string), string stateCode = default(string), string stateNonUsName = default(string))
        {
            // to ensure "addressLine1" is required (not null)
            if (addressLine1 == null)
            {
                throw new ArgumentNullException("addressLine1 is a required property for EmailPhysicalAddress and cannot be null");
            }
            this.AddressLine1 = addressLine1;
            // to ensure "countryCode" is required (not null)
            if (countryCode == null)
            {
                throw new ArgumentNullException("countryCode is a required property for EmailPhysicalAddress and cannot be null");
            }
            this.CountryCode = countryCode;
            // to ensure "organizationName" is required (not null)
            if (organizationName == null)
            {
                throw new ArgumentNullException("organizationName is a required property for EmailPhysicalAddress and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailPhysicalAddress {\n");
