...
namespace ConstantContactApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getContactById_200_response_street_addresses_inner")]
    public partial class GetContactById200ResponseStreetAddressesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetContactById200ResponseStreetAddressesInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetContactById200ResponseStreetAddressesInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetContactById200ResponseStreetAddressesInner" /> class.
        /// </summary>
        ...
        public GetContactById200ResponseStreetAddressesInner(string kind = default(string), string street = default(string), string city = default(string), string state = default(string), string postalCode = default(string), string country = default(string))
        {
            // to ensure "kind" is required (not null)
            if (kind == null)
            {
                throw new ArgumentNullException("kind is a required property for GetContactById200ResponseStreetAddressesInner and cannot be null");
            }
            this.Kind = kind;
            this.Street = street;
            this.City = city;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetContactById200ResponseStreetAddressesInner {\n");
