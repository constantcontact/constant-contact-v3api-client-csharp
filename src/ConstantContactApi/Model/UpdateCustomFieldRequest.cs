...
namespace ConstantContactApi.Model
{
    ...
    public partial class UpdateCustomFieldRequest : IValidatableObject
    {
        ...
        public UpdateCustomFieldRequest(string label = default(string), string type = default(string))
        {
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for UpdateCustomFieldRequest and cannot be null");
            }
            this.Type = type;
        }
