...
namespace ConstantContactApi.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("ConstantContactApiCsharp/1.2.0");
            BasePath = "https://api.cc.email/v3";
        ...
        public Configuration(
            ...
            string basePath = "https://api.cc.email/v3") : this()
        {
        ...
        {
            string report = "C# SDK (ConstantContactApi) Debug Report:\n";
